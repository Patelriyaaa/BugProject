...
const int INITIAL_ANTS = 12;

// Number of initial bugs
const int INITIAL_BUGS = 6;

// Number of initial SuperAnt
const int INITIAL_SUPERANT = 2;

// Number of initial BombBug
const int INITIAL_BOMBBUG = 1;

// Time steps between breeding of ants
const int BREED_ANTS = 6;

// Time steps between breeding of bugs
const int BREED_BUGS = 6;

// Time steps between breeding of SuperAnt
const int BREED_SUPERANT = 5;

// Time steps until bugs die if they have not eaten
const int STARVE_BUGS = 6;

// Time steps until superAnt die if they have not eaten
const int STARVE_SUPERANT = 3;
struct Position
{
	int x;
	int y;
...
public:
	...
	// adds an organism
	void add_Organism(OrganismType orgType);

	// checks if there is space to create and put an organism
	bool check_Full();
